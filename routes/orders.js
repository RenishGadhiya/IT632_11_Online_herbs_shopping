...
//
      ...
      var mailOptions={
        ...
        html:'<h1 style="color:Green;">All Heal</h1><br><h2>Order Placed through All heal for Order Id:'+req.body.order.id+" amounting to "+req.body.order.amount/100+" and will be delivered in 2-3 working days",
      };
